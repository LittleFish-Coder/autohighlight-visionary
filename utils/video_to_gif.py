...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", default="./src/ball_tracking.mp4", help="Input video file path")
    parser.add_argument("--output", default="./src/ball_tracking.gif", help="Output GIF file path")
